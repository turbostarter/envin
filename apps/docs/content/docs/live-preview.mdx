...
The CLI reads your `envin` configuration file, processes all your environment files (`.env` etc.), and starts a local server that you can use to preview your environment variables in real-time.
